    ...
    config = lib.mkIf cfg.enable {
        services.syncthing = {
            ...
            settings = {
                ...
                folders = {
                    # ".zen" = lib.mkIf (builtins.elem configurationName [ "uconsole" "netbook" ]) {
                    #     path = "/home/craft/.zen";
                    #
                    #     devices = [
                    #         "netbook"
                    ...
                    "HGames/Favorites" = lib.mkIf (builtins.elem configurationName [ "desktop" "netbook" "zflip" ]) {
                        path = {
                    ...
                    "HGames/Playing" = lib.mkIf (builtins.elem configurationName [ "desktop" "netbook" "zflip" ]) {
                        path = {
                    ...
                    "programming/nihon-go!" = lib.mkIf (builtins.elem configurationName [ "desktop" "uconsole" "netbook" ]) {
